		...
		<form action="${pageContext.servletContext.contextPath}/addNumbers" method="post">
			<table>
				<tr>
					...
					<td><input type="text" name="first" size="12" value="${addNumb.uno}" /></td>
				</tr>
				<tr>
					<td class="label">Second number:</td>
					<td><input type="text" name="second" size="12" value="${addNumb.dos}" /></td>
				</tr>
				<tr>
					<td class="label">Third number:</td>
					<td><input type="text" name="third" size="12" value="${addNumb.tres}" /></td>
				</tr>
				<tr>
					<td class="label">Result:</td>
					<td>${addNumb.calcular}</td>
				</tr>
			</table>
			<div>
